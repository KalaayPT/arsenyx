        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="prose prose-neutral dark:prose-invert flex max-w-none flex-col gap-8">
            <section>
              ...
              <p>
                By accessing and using {SITE_CONFIG.name}, you agree to be bound by
            ...
            <section>
              ...
              <p>
                {SITE_CONFIG.name} is an open-source Warframe build planner provided
                &quot;as is&quot;. You agree to use this service only for lawful
            ...
            <section>
              ...
              <p>
                Users may create and share builds. By posting content, you grant us a
                license to use, modify, publicly perform, publicly display, reproduce,
                and distribute such content on and through the service. You retain all
                of your ownership rights in your content.
              </p>
            </section>
