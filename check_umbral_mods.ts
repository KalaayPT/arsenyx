...
if (fiber) {
    console.log(JSON.stringify({
        levelStats: fiber.levelStats ? fiber.levelStats[fiber.levelStats.length - 1] : 'No levelStats',
        stats: fiber.stats,
        modSet: fiber.modSet
    }, null, 2));
}
...
if (intensify) {
    console.log(JSON.stringify({
        levelStats: intensify.levelStats ? intensify.levelStats[intensify.levelStats.length - 1] : 'No levelStats',
