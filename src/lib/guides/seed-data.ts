...
export const SEED_GUIDES: Guide[] = [
    {
        ...
        status: "published",
        isCurated: true,
        content: `Railjack is Warframe's ship-based combat system introduced in the Empyrean update. It offers a unique blend of space combat, ground missions, and cooperative gameplay.
...
Start with Earth Proxima missions to learn the basics, then progress to Venus, Neptune, and finally the Veil Proxima for the most challenging content.`,
    ...
    },
    {
        ...
        status: "published",
        content: `Endo is one of the most important resources in Warframe: used to upgrade mods to their maximum potential. Here are the best ways to farm it.
...
**Pro Tip:** Don't forget: Duplicate mods can be dissolved for Endo. Check your inventory regularly for mods you don't need!`,
